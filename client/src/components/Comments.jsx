  ...
  return (
    <div className="comments">
      <div className="newComment">
        ...
        <input ref={inputRef} onChange={handleComment} type="text" name="comment" placeholder="Type comment..." />
        <Button type="primary"  onClick={handleSubmitComment}>comment</Button>
      </div>
